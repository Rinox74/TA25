...
const API_URL = '/api'; // Il backend è ora servito dalla stessa origine
...
export const apiService = {
  ...
  // --- DATABASE SETUP ---
  setupDatabase: (settings: AppSettings): Promise<{ message: string }> => apiRequest('/setup-database', { method: 'POST', body: JSON.stringify(settings) }),
};